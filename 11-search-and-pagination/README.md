...
```sh
npx create-next-app@latest financial-dashboard --example "https://github.com/Damianvit/Next-js-15_financial-dashboard/tree/main/11-search-and-pagination/starter-template" --use-pnpm
```
